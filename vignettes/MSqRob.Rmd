...
system.time(modelRRCPTAC <- fit.model(protdata=proteinsCPTAC, response="quant_value", fixed=c("conc","instrlab"), random=c("Sequence","run"), add.intercept=TRUE, shrinkage.fixed=NULL, weights="Huber", k = 1.345, tolPwrss = 1e-10, verbose=FALSE))
```
