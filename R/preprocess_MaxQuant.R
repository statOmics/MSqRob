...
#' @export
read2MSnSet <- function(file, pattern, remove_pattern=FALSE, shiny=FALSE, message=NULL)
{
...
{
  peptides <- read2MSnSet(file=file, pattern=pattern, remove_pattern=remove_pattern, shiny=shiny, message=message)
  return(peptides)
}
...
#' @export
preprocess_MSnSet <- function(MSnSet, accession="prot", exp_annotation=NULL, type_annot=NULL, logtransform=TRUE, base=2, normalisation="quantiles", smallestUniqueGroups=TRUE, useful_properties=NULL, filter=NULL, filter_symbol=NULL, minIdentified=2, external_filter_file=NULL, external_filter_accession=NULL, external_filter_column=NULL, colClasses=NA, printProgress=FALSE, shiny=FALSE, message=NULL, details=NULL)
{
  #Error control
...
preprocess_MaxQuant <- function(MSnSet, accession="Proteins", exp_annotation=NULL, type_annot=NULL, logtransform=TRUE, base=2, normalisation="quantiles", smallestUniqueGroups=TRUE, useful_properties=c("Proteins","Sequence","PEP"), filter=c("Potential.contaminant","Reverse"), filter_symbol="+", minIdentified=2, remove_only_site=FALSE, file_proteinGroups=NULL, colClasses=NA, printProgress=FALSE, shiny=FALSE, message=NULL)
{
  ...
  MSnSet <- preprocess_MSnSet(MSnSet=MSnSet, accession=accession, exp_annotation=exp_annotation, type_annot=type_annot, logtransform=logtransform, base=base, normalisation=normalisation, smallestUniqueGroups=smallestUniqueGroups, useful_properties=useful_properties, filter=filter, filter_symbol=filter_symbol, minIdentified=minIdentified,
